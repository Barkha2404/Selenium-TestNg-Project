...
public class FixedDeposit_test {
  ...
  @Test(priority = 0,description = "Test case to verify fixed deposit for '200000'")
  ...
  @Test(priority = 1, description = "Test case to verify fixed deposit for '100000'")
